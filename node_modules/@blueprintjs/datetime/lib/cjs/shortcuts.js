...
var Shortcuts = /** @class */ (function (_super) {
    ...
    function Shortcuts() {
        ...
        _this.isShortcutInRange = function (shortcutDateRange) {
            ...
            return dateUtils_1.isDayRangeInRange(shortcutDateRange, [minDate, maxDate]);
        };
        return _this;
    }
    Shortcuts.prototype.render = function () {
        ...
        var shortcutElements = shortcuts.map(function (shortcut, index) { return (React.createElement(core_1.MenuItem, { active: _this.props.selectedShortcutIndex === index, className: core_1.Classes.POPOVER_DISMISS_OVERRIDE, disabled: !_this.isShortcutInRange(shortcut.dateRange), key: index, onClick: _this.getShorcutClickHandler(shortcut, index), text: shortcut.label })); });
...
function createDefaultShortcuts(allowSingleDayRange, hasTimePrecision, useSingleDateShortcuts) {
    ...
    var singleDayShortcuts = allowSingleDayRange || useSingleDateShortcuts
        ...
        : [];
    return tslib_1.__spreadArrays(singleDayShortcuts, [
