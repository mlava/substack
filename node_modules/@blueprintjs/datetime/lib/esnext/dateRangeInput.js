...
let DateRangeInput = DateRangeInput_1 = class DateRangeInput extends AbstractPureComponent2 {
    ...
    render() {
        ...
        React.createElement(Popover, Object.assign({ isOpen: this.state.isOpen, position: Position.BOTTOM_LEFT }, this.props.popoverProps, { autoFocus: false, className: popoverClassName, content: popoverContent, enforceFocus: false, onClose: this.handlePopoverClose }),
